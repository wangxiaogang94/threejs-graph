...
class App extends React.Component {
    ...
    mesh = null;
    componentDidMount() {
        const width = document.getElementById('box1').clientWidth;
        const height = document.getElementById('box1').clientHeight;
    ...
    init = (width,height) => {
        ...
        document.getElementById('box1').appendChild(this.renderer.domElement);
    };
    ...
    render() {
        return (
            <div id="box1" style={{border:'1px solid red', width: '100%', height: '100vh'}}>
            </div>
        );
    }
}
